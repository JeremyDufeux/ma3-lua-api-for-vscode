...
function Handle:GridGetFirstSelectedObject()
    return Handle:new()
end
...
function Handle:IsClass(className)
    return false
end
...
---@return boolean result
function Handle:IsRunningPlayback()
    return false
end
