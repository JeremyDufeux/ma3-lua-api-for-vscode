...
---@param imageA Handle
---@param imageB Handle
---@param diffOut Handle
---@return integer differingPixels
function CompareImages(imageA, imageB, diffOut)
    return 0
end
...
---@return Handle currentDatapool
function CurrentDataPool()
    return Handle:new()
end

---@return Handle currentObject
...
---@param phaserOnly boolean @Optional @default: false
---@param byFixtures boolean @Optional @default: true
---@return table phaserData
function GetPresetDataFast(phaserOnly, byFixtures)
    return Handle:new()
end
