...
Enums.AssignmentButtonFunctionsBlind = {
  [""] = 0,
  Empty = 0,
  Off = 8,
  On = 7,
...
Enums.AssignmentButtonFunctionsGrandMaster = {
  [""] = 0,
  Empty = 0,
  Off = 8,
  On = 7,
...
Enums.AssignmentButtonFunctionsHighlightSolo = {
  [""] = 0,
  Empty = 0,
  Off = 8,
  On = 7,
...
Enums.AssignmentButtonFunctionsPlaybackMaster = {
  [""] = 0,
  Empty = 0,
}
...
Enums.AssignmentButtonFunctionsRate = {
  [""] = 0,
  Empty = 0,
  Off = 8,
  On = 7,
...
Enums.AssignmentButtonFunctionsSoundMaster = {
  [""] = 0,
  Empty = 0,
  Off = 8,
  On = 7,
...
Enums.AssignmentButtonFunctionsSpeed = {
  [""] = 0,
  DoubleSpeed = 27,
  Empty = 0,
  FastSync = 31,
...
Enums.AssignmentButtonFunctionsTag = {
  [""] = 0,
  ["<<<"] = 6,
  [">>>"] = 5,
  DoubleSpeed = 27,
...
Enums.AssignmentButtonFunctionsTimecode = {
  [""] = 0,
  ["<<<"] = 6,
  [">>>"] = 5,
  At = 48,
...
-- @enum ButtonModeFunction
Enums.ButtonModeFunction = {
  ["Flash / Black"] = 1,
  ["Full / Zero"] = 0,
}

-- @enum ButtonModeFunctionSpeedMaster
Enums.ButtonModeFunctionSpeedMaster = {
  Learn = 0,
  Speed1 = 1,
}
...
Enums.DeprecatedExecConfigType = {
  Master = 11,
}

-- @enum DeprecatedLearnMode
Enums.DeprecatedLearnMode = {
  Default = 0,
}
...
Enums.DynamicPresetModeDefault = {
  Default = 0,
  ForceGlobal = 4,
  ForceUniversal = 5,
  Global = 2,
...
-- @enum FixtureLibraryChannelSort
Enums.FixtureLibraryChannelSort = {
  Channels = 0,
  Structure = 1,
}
...
Enums.HardwareButtonDisplayMode = {
  Icon = 2,
  Text = 1,
  ["Text+Icon"] = 0,
}
...
Enums.LearnMode = {
  ...
  ["Learn Ignores Speed Scale"] = 0,
  ["Learn Respects Speed Scale"] = 1,
}

-- @enum LearnModeSuffix
...
-- @enum MasterTitleFunction
Enums.MasterTitleFunction = {
  Locate = 0,
  SelectFixtures = 1,
}
...
Enums.MessageCenterRememberedTab = {
  Messages = 0,
  Statuses = 1,
}
...
Enums.MidiShowControlCommandMode = {
  All = 127,
  Extensions = 0,
  ["General Light"] = 1,
  ["Moving Light"] = 2,
...
Enums.MidiShowControlRowDisabled = {
  Disabled = 65535,
}

-- @enum MidiShowControlSendTo
Enums.MidiShowControlSendTo = {
  All = 2,
  Device = 1,
  Group = 0,
}
...
Enums.PathType = {
  ...
  Software = 59,
  Statistics = 17,
  SymbolImageLibrary = 37,
  Temp = 12,
  TemplateShowfiles = 65,
  Textures = 30,
  Undo = 13,
  UpdateDir = 6,
  ...
  UserExecutors = 115,
  UserFilters = 114,
  UserFixtureTypeResources = 84,
  UserFixtures = 83,
  UserGdtfResources = 89,
  UserGels = 99,
  UserGenerators = 119,
  UserGobos = 85,
  UserGroups = 111,
  ...
  UserRemotesDMX = 79,
  UserRemotesMIDI = 80,
  UserRenderQuality = 97,
  UserScreenConfigurations = 96,
  UserSequences = 112,
  UserShapes = 121,
  UserSoundLibrary = 67,
  UserStages = 123,
  ...
  VersionDir = 4,
  VideoLibrary = 39,
  ViewButtonLibrary = 94,
  VizLibrary = 60,
  WebDaemon = 7,
  WebResource = 24,
  WorldServerLibrary = 56,
}

-- @enum PhaseRangesValue
Enums.PhaseRangesValue = {
...
-- @enum PhaserRecipeContextTab
Enums.PhaserRecipeContextTab = {
  Editor = 2,
  List = 1,
  Pool = 0,
}
...
Enums.PhaserRecipeDirection = {
  Alternate = 2,
  Backward = 1,
  Forward = 0,
}

-- @enum PhaserRecipeStepLinking
Enums.PhaserRecipeStepLinking = {
  [""] = 0,
  Linked = 1,
  None = 0,
}
...
Enums.PhaserRecipeValueSpecials = {
...
-- @enum PhaserRecipeValueSpecialsRaw
Enums.PhaserRecipeValueSpecialsRaw = {
  ChannelFunctionDefault = 1124073473,
  Default = 1124073474,
  Full = 1124073478,
  Highlight = 1124073475,
...
Enums.PresetModeWithoutDefault = {
  Global = 2,
  Selective = 1,
  Universal = 3,
}
...
Enums.RecipeContextMenu = {
  GridContextBoolean = 2,
  GridContextCurve = 18,
  GridContextMatricks = 9,
  GridContextNShotDirection = 19,
  GridContextNone = 0,
  GridContextNumericKeypadMeasure = 14,
  GridContextNumericKeypadNshot = 15,
  GridContextNumericKeypadPart = 13,
  GridContextNumericKeypadPhase = 17,
  GridContextNumericKeypadSpeed = 16,
  GridContextNumericKeypadValues = 6,
  GridContextPhaserRecipe = 11,
  GridContextRotation = 20,
  GridContextSpeedMaster = 21,
  GridContextStandardRecipe = 12,
  ShapeEditContent = 5,
}

-- @enum RecipeContextPool
Enums.RecipeContextPool = {
  GridContextPoolFilter = 8,
  GridContextPoolMatricks = 9,
  GridContextPoolSelection = 4,
  GridContextPoolShapes = 5,
  GridContextPoolValues = 6,
}

-- @enum RecipeContextSheet
Enums.RecipeContextSheet = {
  GridContextSheetAttributes = 10,
  GridContextSheetFilter = 8,
  GridContextSheetSelection = 4,
  GridContextSheetValues = 6,
}

-- @enum RecipePresetReadoutMode
Enums.RecipePresetReadoutMode = {
  ID = 3,
  ["ID+Long Name"] = 6,
  ["ID+Name"] = 4,
  Name = 0,
...
Enums.ResolutionLimitUnlimited = {
  ["1080p"] = 2,
  ["1440p"] = 3,
  ["480p"] = 0,
  ["4k"] = 4,
...
-- @enum ShapePhaserRecipeDirection
Enums.ShapePhaserRecipeDirection = {
  Alternate = 2,
  Backward = 1,
  Forward = 0,
...
-- @enum SpeedMasterMtxOverride
Enums.SpeedMasterMtxOverride = {
  [""] = 255,
  BPM = 15,
  ["No Master"] = 254,
  None = 255,
...
-- @enum TimeDisplayFormatDefault
Enums.TimeDisplayFormatDefault = {
  ["10.11:23:45"] = 2,
  ["10d11h23m45"] = 0,
  ["251:23:45"] = 3,
  ["251h23m45"] = 1,
...
Enums.TimeNoneSwapSpeed = {
  ["No Speed"] = 9223372036854775805,
  None = 9223372036854775807,
  ["Swap Speed"] = 9223372036854775806,
}

-- @enum TimeRecipeSpeed
Enums.TimeRecipeSpeed = {
  Double = 9223372036854775804,
  Half = 9223372036854775803,
  ["No Speed"] = 9223372036854775805,
  ["Swap Speed"] = 9223372036854775806,
}
...
-- @enum UserRightsWithoutNone
Enums.UserRightsWithoutNone = {
  Admin = 0,
  Playback = 4,
  Presets = 3,
  Program = 2,
